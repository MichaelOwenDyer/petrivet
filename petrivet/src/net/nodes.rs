...
/// Opaque handle to a transition. Valid from the moment it is returned by
/// [`super::builder::NetBuilder::add_transition`] through the lifetime of any
/// [`super::Net`] built from that builder (provided the transition was not
/// removed before building).
#[derive(Debug, Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
