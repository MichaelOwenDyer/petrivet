...
fn is_s_net<>(
    transition_presets: &HashMap<Transition, HashSet<Place>>,
    transition_postsets: &HashMap<Transition, HashSet<Place>>
) -> bool {
...
fn is_t_net(
    place_presets: &HashMap<Place, HashSet<Transition>>,
    place_postsets: &HashMap<Place, HashSet<Transition>>
) -> bool {
